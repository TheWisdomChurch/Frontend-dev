...
export default function SeniorPastor() {
  ...
  return (
    ...
    >
      <div
        className="grid min-h-[580px] grid-cols-1 lg:min-h-[700px]"
        style={{ gridTemplateColumns: '1fr 1fr' }}
      >
        {/* ── Left — cinematic full-height portrait ─────────── */}
        <div className="relative order-1 min-h-[400px] overflow-hidden lg:order-none lg:min-h-0">
          <Image
            src={Bishop}
            ...
            quality={92}
            className="object-cover [object-position:center_12%]"
          />
          {/* Mobile bottom fade */}
          <div className="absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-[var(--app-dark)] to-transparent lg:hidden" />
        ...
        <div className="order-2 flex flex-col justify-center px-6 py-14 sm:px-10 lg:order-none lg:px-12 xl:px-16">
          {/* Eyebrow */}
          ...
          {/* Bio */}
          <p className="mt-7 max-w-[420px] font-ui text-[0.92rem] leading-[1.9] text-white/55">
            {bio}
          </p>
