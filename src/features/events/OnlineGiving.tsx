  ...
  return (
    <>
      <Section tone="dark" className="bg-[var(--app-dark-2)]">
        <Container>
          <div className="grid items-start gap-10 sm:gap-12 md:gap-10 lg:grid-cols-[minmax(0,0.84fr)_minmax(0,1.16fr)] lg:gap-14 xl:gap-20">
            <div className="contents lg:block lg:max-w-xl lg:self-start lg:sticky lg:top-28">
              <div className="order-1 lg:order-none">
                ...
                >
                  ...
                  <blockquote className="mt-5 font-ui text-body-lg italic leading-relaxed text-[var(--app-text)]">
                    &ldquo;As each has purposed in his heart, so let him give…
                    God loves a cheerful giver.&rdquo;
                  </blockquote>
              ...
              <div className="order-3 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center lg:order-none lg:mt-8">
                <button
                  type="button"
                ...
                >
                  <div>
                    ...
                    <p className="mt-4 max-w-lg font-ui text-body-md leading-loose text-[var(--app-muted)]">
                      ...
                      out and we&rsquo;ll walk you through the ways to give
                      today.
                    </p>
                  </div>
                  <Link
