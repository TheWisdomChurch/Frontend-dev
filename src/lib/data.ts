...
export const resourceLinks = [
  ...
  {
    title: 'Publications',
    subtitle: 'Books & study guides',
    description: 'A growing digital resource library for personal study',
  ...
  },
  {
    ...
    description: 'Short reads to encourage and challenge your walk of faith',
