...
export default function TestimoniesPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Prepare data according to TestimonialType interface
    const testimonialData = {
      id: 0, // Will be assigned by the backend
      firstName: formData.firstName,
      lastName: formData.lastName,
      fullName: formData.anonymous ? 'Anonymous' : `${formData.firstName} ${formData.lastName}`.trim(),
  ...
  return (
    ...
    >
      <Container size="xl">
        {/* Added proper spacing container with padding top */}
                ...
                >
                  ...
                  <div className="p-6 lg:p-8">
                    <form onSubmit={handleSubmit} className="space-y-6 lg:space-y-8">
                      {/* Profile Image Upload - Hidden if anonymous */}
                      {!formData.anonymous && (
                        <div className="space-y-2">
                          ...
                          <div className="flex flex-col sm:flex-row items-center gap-4">
                            <div 
                              className="w-24 h-24 rounded-full border-2 flex items-center justify-center cursor-pointer overflow-hidden"
                              style={{ 
                            ...
                            >
                              {imagePreview ? (
                                ...
                                <div className="flex flex-col items-center justify-center">
                                  <Camera className="w-8 h-8 mb-1" style={{ color: colorScheme.textSecondary }} />
                                  <BodySM className="text-xs" style={{ color: colorScheme.textSecondary }}>
                                    Add Photo
                                  </BodySM>
                                </div>
                              )}
                            ...
                            <div className="flex-1">
                              ...
                              <div className="space-y-2">
                                <BodySM style={{ color: colorScheme.textSecondary }}>
                                  Add a photo to personalize your testimony (optional)
                                </BodySM>
                                <div className="flex gap-2">
                                  <button
                                    type="button"
                                    onClick={() => fileInputRef.current?.click()}
                                    className="px-4 py-2 rounded-lg border hover:bg-opacity-50 transition-colors text-sm"
                                    style={{ 
                                      borderColor: getBorderColor(),
                                      backgroundColor: colorScheme.background,
                ...
                >
                  ...
                  <div className="p-6 lg:p-8 space-y-6 lg:space-y-8">
                    ...
                    <div className="rounded-lg p-4 mt-4" 
                      style={{ 
                        backgroundColor: getPrimaryBackgroundWithOpacity(),
                        border: `1px solid ${colorScheme.borderLight}`
                      }}
                    >
                      <BodySM style={{ color: colorScheme.textSecondary }}>
                        <span className="font-semibold" style={{ color: colorScheme.text }}>Note:</span> When submitting anonymously, your name and photo will be hidden. Your email is collected for verification purposes only and will not be shared publicly.
                      </BodySM>
                    </div>
                  </div>
                </div>
