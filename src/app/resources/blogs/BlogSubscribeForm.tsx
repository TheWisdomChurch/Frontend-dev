  ...
  return (
    ...
    >
      <input
        ...
        className="flex-1 border border-white/15 bg-white/[0.04] px-4 py-3 font-ui text-body-sm text-white placeholder:text-white/45 focus:border-[color-mix(in_srgb,var(--app-primary)_60%,transparent)] focus:outline-none disabled:opacity-50"
      />
      <button
        type="submit"
        disabled={status === 'loading'}
