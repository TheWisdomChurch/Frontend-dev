...
const socials = [
  { href: 'https://www.instagram.com/wisdomhousehq', label: 'Instagram', Icon: IconInstagram },
  { href: 'https://www.youtube.com/@wisdomhousehq', label: 'YouTube', Icon: IconYoutube },
  { href: 'https://www.facebook.com/wisdomhousehq', label: 'Facebook', Icon: IconFacebook },
