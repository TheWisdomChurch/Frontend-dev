...
.PHONY: help setup install dev build start preview architecture security test typecheck lint lint-fix format format-fix \
...
security: ## Fail on high-severity production dependency advisories
	npm run security:check

test: ## Run automated domain and state tests once
	npm test
...
check: architecture typecheck lint format test ## Run fast local quality checks
